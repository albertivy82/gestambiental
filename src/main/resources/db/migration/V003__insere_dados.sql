...
('Paulo José da Silva', 'Graviola', 'Finlândia', 'MASCULINO', '95', 'Ensino médio incompleto', 'SOLTEIRO', 'Católico', 'Sim', 'Entre 1 e 5 anos', 'TESTE', 'TESTE', 'VEGETAIS', 'OUTRA_LOCALIDADE, Outras: TESTE', 'Limpeza pública', '0', '0', 'TESTE', 'Não', '', 'Sim', 'Sim', 'Não', 'Não', 'Teste', 'Tezt', 'Tez', 'Instituições Conhecidas: Teste', 'Teste', 'Testetets', 'Teste', 'Teste', 'CONSULTA_COM_O_ENFERMEIRO_NO_POSTO_DE_SAUDE', '1');
