...
INSERT INTO `dadossocioambienenentais`.`localidade` (`nome`, `municipio`, `esfera`) VALUES ('Boa Vista de Irirteua', 'CURUÇÁ', 'ESTADUAL');
...
INSERT INTO `dadossocioambienenentais`.`imovel` (`rua`, `numero`, `bairro`, `referencial`, `latitude`, `longitude`, `situacao_fundiaria`, `documentacao_imovel`, `data_chegada`, `pretende_mudar`, `motivo_vontade_mudanca`, `relacao_area`, `relacao_vizinhos`, `limites`, `iluminacao_publica`, `transporte`, `linhas_de_barco`, `tipo_solo`, `esporte_lazer`, `localidade`) VALUES ('RUA 2', 'S/N', 'PEDREIRINHA', 'PERTO DA FEIRA', '456454', '76576', 'PROPRIETARIO', 'NÃO_POSSUI', '1982-09-20', 'SIM', 'CONFLITOS FUNDIÁRIOS', 'SEMPRE MOROU NO LOCAL', 'BOA', 'MURO_ALVENARIA','NÃO', 'MOTO', 'NÃO', 'TERRA_FIRME', 'SEDE_ESPORTIVA', '1');
INSERT INTO `dadossocioambienenentais`.`imovel` (`rua`, `numero`, `bairro`, `referencial`, `latitude`, `longitude`, `situacao_fundiaria`, `documentacao_imovel`, `data_chegada`,`pretende_mudar`, `motivo_vontade_mudanca`, `relacao_area`, `relacao_vizinhos`, `limites`, `iluminacao_publica`,`transporte`, `linhas_de_barco`, `tipo_solo`, `esporte_lazer`, `localidade`) VALUES ('RUA 3', 'S/N', 'PEDREIRINHA', 'EM FRENTE AO CAMPINHO', '456454', '76576', 'PROPRIETARIO', 'NÃO_POSSUI', '1982-09-20', 'NÃO', 'NÃO INFORMADO', 'SEMPRE MOROU NO LOCAL', 'BOA', 'MURO_ALVENARIA', 'SIM','MOTO', 'NÃO', 'TERRA_FIRME', 'SEDE_ESPORTIVA', '1');
INSERT INTO `dadossocioambienenentais`.`imovel` (`rua`, `numero`, `bairro`, `referencial`, `latitude`, `longitude`, `situacao_fundiaria`, `documentacao_imovel`, `data_chegada`, `pretende_mudar`, `motivo_vontade_mudanca`, `relacao_area`, `relacao_vizinhos`, `limites`, `iluminacao_publica`,`transporte`, `linhas_de_barco`, `tipo_solo`, `esporte_lazer`, `localidade`) VALUES ('RUA 2', 'S/N', 'PEDREIRINHA', 'PERTO DA FEIRA', '456454', '76576', 'PROPRIETARIO', 'NÃO_POSSUI', '1982-09-20', 'NÃO', 'NÃO INFORMADO','SEMPRE MOROU NO LOCAL', 'BOA', 'MURO_ALVENARIA', 'SIM','MOTO', 'NÃO', 'TERRA_FIRME', 'SEDE_ESPORTIVA', '1');
INSERT INTO `dadossocioambienenentais`.`imovel` (`rua`, `numero`, `bairro`, `referencial`, `latitude`, `longitude`, `situacao_fundiaria`, `documentacao_imovel`, `data_chegada`,`pretende_mudar`, `motivo_vontade_mudanca`, `relacao_area`, `relacao_vizinhos`, `limites`, `iluminacao_publica`,`transporte`, `linhas_de_barco`, `tipo_solo`, `esporte_lazer`, `localidade`) VALUES ('RUA SMAÚMA', '45 A', 'DAS PEDRAS', 'PRÓXIMO AO IGARAPÉ', '456454', '76576', 'PROPRIETARIO', 'NÃO_POSSUI', '1982-09-20', 'NÃO', 'NÃO INFORMADO', 'SEMPRE MOROU NO LOCAL', 'BOA', 'MURO_ALVENARIA', 'NÃO','MOTO', 'NÃO', 'TERRA_FIRME', 'SEDE_ESPORTIVA', '2');
INSERT INTO `dadossocioambienenentais`.`imovel` (`rua`, `numero`, `bairro`, `referencial`, `latitude`, `longitude`, `situacao_fundiaria`, `documentacao_imovel`, `data_chegada`, `pretende_mudar`, `motivo_vontade_mudanca`,`relacao_area`, `relacao_vizinhos`, `limites`, `iluminacao_publica`,`transporte`, `linhas_de_barco`, `tipo_solo`, `esporte_lazer`, `localidade`) VALUES ('RUA BURIT', '654', 'RIACHINHO', 'PERTO DA FEIRA', '456454', '76576', 'PROPRIETARIO', 'NÃO_POSSUI', '1982-09-20', 'SIM', 'GARIMPO','SEMPRE MOROU NO LOCAL', 'BOA', 'MURO_ALVENARIA', 'SIM','MOTO', 'NÃO', 'TERRA_FIRME', 'SEDE_ESPORTIVA', '2');
INSERT INTO `dadossocioambienenentais`.`imovel` (`rua`, `numero`, `bairro`, `referencial`, `latitude`, `longitude`, `situacao_fundiaria`, `documentacao_imovel`, `data_chegada`, `pretende_mudar`, `motivo_vontade_mudanca`, `relacao_area`, `relacao_vizinhos`, `limites`, `iluminacao_publica`,`transporte`, `linhas_de_barco`, `tipo_solo`, `esporte_lazer`, `localidade`) VALUES ('RUA WE6', '562B', 'MANAGABEIRA', 'NA VILA AGROPECUÁRIA', '456454', '76576', 'PROPRIETARIO', 'NÃO_POSSUI', '1982-09-20', 'NÃO', 'SEMPRE MOROU NO LOCAL', 'SEMPRE MOROU NO LOCAL', 'BOA', 'MURO_ALVENARIA','NÃO', 'MOTO', 'NÃO', 'TERRA_FIRME', 'SEDE_ESPORTIVA', '3');
INSERT INTO `dadossocioambienenentais`.`imovel` (`rua`, `numero`, `bairro`, `referencial`, `latitude`, `longitude`, `situacao_fundiaria`, `documentacao_imovel`, `data_chegada`, `pretende_mudar`, `motivo_vontade_mudanca`, `relacao_area`, `relacao_vizinhos`, `limites`, `iluminacao_publica`,`transporte`, `linhas_de_barco`, `tipo_solo`, `esporte_lazer`, `localidade`) VALUES ('SN 15', 'S/N', 'MIRITI', 'NA ENTRADA DA CIDADE', '456454', '76576', 'PROPRIETARIO', 'NÃO_POSSUI', '1982-09-20', 'NÃO', 'NÃO INFORMOU', 'SEMPRE MOROU NO LOCAL', 'BOA', 'MURO_ALVENARIA', 'NÃO','MOTO', 'NÃO', 'TERRA_FIRME', 'SEDE_ESPORTIVA', '3');
INSERT INTO `dadossocioambienenentais`.`imovel` (`rua`, `numero`, `bairro`, `referencial`, `latitude`, `longitude`, `situacao_fundiaria`, `documentacao_imovel`, `data_chegada`, `pretende_mudar`, `motivo_vontade_mudanca`, `relacao_area`, `relacao_vizinhos`, `limites`, `iluminacao_publica`,`transporte`, `linhas_de_barco`, `tipo_solo`, `esporte_lazer`, `localidade`) VALUES ('ARSENAL', '56', 'CREMAÇÃO', 'PRÓXIMA A ÁREA PARA UC', '456454', '76576', 'PROPRIETARIO', 'NÃO_POSSUI', '1982-09-20', 'SIM', 'ALAGAMENTOS CONSTANTES', 'SEMPRE MOROU NO LOCAL', 'BOA', 'MURO_ALVENARIA','NÃO', 'MOTO', 'NÃO', 'TERRA_FIRME', 'SEDE_ESPORTIVA', '3');

INSERT INTO `dadossocioambienenentais`.`escola` (`nome`, `educacao_ambiental`, `merenda`, `transporte`, `localidade`) VALUES ('ESCOLA ESTADUAL DE ENSINO FUNDAMENTAL E MÉDIO NOSSA SENHORA DAS GRAÇAS', 'SIM', 'NÃO', 'SIM', '1');
INSERT INTO `dadossocioambienenentais`.`escola` (`nome`, `educacao_ambiental`, `merenda`, `transporte`, `localidade`) VALUES ('ESCOLA ESTADUAL DE ENSINO FUNDAMENTAL E MÉDIO PROFESSOR AMBRÓSIO', 'SIM', 'SIM', 'SIM', '1');
INSERT INTO `dadossocioambienenentais`.`escola` (`nome`, `educacao_ambiental`, `merenda`, `transporte`, `localidade`) VALUES ('ESCOLA MUNICIPAL DE ENSINO FUNDAMENTAL E MÉDIO GENERAL LIMA', 'SIM', 'SIM', 'NÃO', '2');
INSERT INTO `dadossocioambienenentais`.`escola` (`nome`, `educacao_ambiental`, `merenda`, `transporte`, `localidade`) VALUES ('ESCOLA ESTADUAL DE ENSINO FUNDAMENTAL E MÉDIO PROFESSORA JÚLIA', 'NÃO', 'SIM', 'SIM', '3');
INSERT INTO `dadossocioambienenentais`.`escola` (`nome`, `educacao_ambiental`, `merenda`, `transporte`, `localidade`) VALUES ('ESCOLA ESTADUAL DE ENSINO FUNDAMENTAL E MÉDIO NOSSA SENHORA DE NAZARÉ', 'SIM', 'NÃO', 'SIM', '3');




INSERT INTO `dadossocioambienenentais`.`posto_de_saude` (`nome`, `ambulatorial`, `urgencia_emergencia`, `medicos_por_turno`, `localidade`) VALUES ('POSTO MUNICIPAL', 'SIM', 'NÃO', '4', '1');
INSERT INTO `dadossocioambienenentais`.`posto_de_saude` (`nome`, `ambulatorial`, `urgencia_emergencia`, `medicos_por_turno`, `localidade`) VALUES ('POSTO MUNICIPAL', 'SIM', 'SIM', '6', '2');
INSERT INTO `dadossocioambienenentais`.`posto_de_saude` (`nome`, `ambulatorial`, `urgencia_emergencia`, `medicos_por_turno`, `localidade`) VALUES ('POSTO MUNICIPAL', 'NÃO', 'SIM', '2', '3');
