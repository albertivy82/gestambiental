...
('Paulo José da Silva', 'Graviola', 'Finlândia', 'MASCULINO', '2025-06-11', 'ENSINO_SUPERIOR_COMPLETO', 'SOLTEIRO', 'Católico', 'SIM', '2025-06-11', 'TESTE', 'TESTE', 'VEGETAIS', 'OUTRA_LOCALIDADE, Outras: TESTE', 'Limpeza pública', '0', '0', 'TESTE', 'NÃO', '', 'SIM', 'SIM', 'NÃO', 'NÃO', 'Teste', 'Tezt', 'Tez', 'Instituições Conhecidas: Teste', 'Teste', 'Testetets', 'Teste', 'Teste', 'CONSULTA_COM_O_ENFERMEIRO_NO_POSTO_DE_SAUDE', '1');

INSERT INTO `dadossocioambientais`.`imovel` (`rua`, `numero`, `bairro`, `referencial`, `latitude`, `longitude`, `area_imovel`, `tipo_solo`, `vizinhos_confinantes`, `situacao_fundiaria`, `documentacao_imovel`, `limites`, `linhas_de_barco`, `pavimentacao`, `iluminacao_publica`, `equipamentos_urbanos`, `espacos_esporte_lazer`, `programa_infra_saneamento`, `entrevistado`) VALUES ('Rua', 'Numero', 'Baitro', 'Ref', 'Lat', 'Teste', '9.64', 'TERRA_FIRME', 'LADO_DIREITO, NAO_DECLARADO', 'POSSE', 'TÍTULO_DE_POSSE', 'CERCA_VIVA', 'Barcos', 'BLOKET', 'SIM', 'NÃO', 'BALNEÁRIOS', 'Teste', '1');
